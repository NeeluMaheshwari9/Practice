...
with open('C:/Users/admin/PycharmProjects/Practice/TimecardAutomation/timecard_resource.yml', 'r') as yml_f:
...
class TimecardEntry:
    ...
    def automate(self):
        ...
        try:
            self.workbook = xlrd.open_workbook("timesheet_data.xls")
