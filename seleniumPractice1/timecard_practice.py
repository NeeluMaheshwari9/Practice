"""
This script is to automate timesheet using Selenium webself.driver.
Reads an Excel workbook (consist: config and individual sheets for week details) through xlrd module
and update timecard or adjustment summary.
"""
import sys
import time
import re
...
class TimecardEntry:
    ...
    def operation(self):
        ...
        if operate == "save":
            ...
            time.sleep(10)  # back from timecard
                    ...
                    for j in range(column_count):
                        ...
                        if week_entry.is_enabled():
                            if field_id[j] == "ddlTask']":
                                old_value = value
                                print("old value of task", old_value)
                            else:
    ...
    def automate(self):
        ...
        # SELECT_TAB = str.lower(workbook[0].cell_value(3, 1))
...
if __name__ == "__main__":
    OBJ = TimecardEntry()
    OBJ.automate()
    # service = Service(executable_path='C:/self.drivers/chromeself.driver_win32/chromeself.driver.exe')
    # self.driver = webself.driver.Chrome(service=service)
    # self.driver.get("https://timecard.in.capgemini.com")
    # print("Timesheet opened on chrome...")
    # self.driver.maximize_window()
    # # Timesheet on Chrome browser opened and maximized
    # try:
    #     workbook = xlrd.open_workbook("C:/Users/admin/Downloads/timesheet_data.xls")
    # # except Exception:
    # #     print("Excel sheet is not available")
    ...
    # SELECT_TAB = str.lower(workbook[0].cell_value(3, 1))
    # # reading tab choice for timecard updates
    # if SELECT_TAB == "timecard":
    #     timecard()
    #     # selected choice is Timecard summary
    # elif SELECT_TAB == 'adjustment':
    #     adjustment()
    #     # selected choice is Adjustment summary
    # week_validation()
    # # week validation from config week entry
